...
`astrbot_sandbox_shipyard_neo` 是 AstrBot 的 Shipyard Neo 沙盒驱动插件。

它面向 Bay / Shipyard Neo 部署。除了 Shell、Python 和文件操作，还提供浏览器自动化和 Neo Skill 生命周期工具。

## 功能特性

- 提供 `shipyard_neo` 沙盒驱动。
- 支持 Shell、Python、文件操作和浏览器能力。
- 自动注册浏览器自动化工具。
